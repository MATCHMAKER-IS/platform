...
export const PLATFORM_DEMOS: DemoEntry[] = [
  // ── 見せる・可視化 ──
  { href: "/bulk", title: "一括操作と取り消し", desc: "選んでまとめて処理し、5 分以内なら取り消せます",
    packages: ["ui"] , group: "見せる・可視化" },
  { href: "/toolbox", title: "小さな道具", desc: "バイト列・色・JSON・XML・ブラウザ保存",
    packages: ["bytes", "color", "json", "web-storage"] , group: "見せる・可視化" },
  ...
  { href: "/schedule", title: "スケジュール(月/週/日)", desc: "月・週・日・一覧の切替カレンダー・タスク/会議イベント・祝日表示",
    packages: ["ui", "datetime"], group: "入力・フォーム" },
  { href: "/lending", title: "備品貸出の記録", desc: "一覧・登録・返却だけの最小画面。DataTable と入力部品の基本形",
    packages: ["ui"], group: "入力・フォーム" },
  { href: "/meeting-room", title: "会議室予約の記録", desc: "一覧・登録・取消と、同じ部屋・同じ日の二重予約を防ぐ検証",
    packages: ["ui"], group: "入力・フォーム" },
  { href: "/expense-request", title: "経費申請の記録", desc: "科目の選択・金額の検証・合計。金額は @platform/report の formatYen で揃える",
    packages: ["ui", "report"], group: "入力・フォーム" },
  { href: "/japanese-form", title: "日本語の申込フォーム", desc: "ふりがなの自動入力・和暦の併記・郵便番号の桁検証。日本の業務でしか要らない部品",
    packages: ["ui", "datetime", "address", "utils"], group: "入力・フォーム" },
  // ── 認証・セキュリティ ──
