    ...
    <>
          ...
          <tbody>
            {TOOLS.map((t) => (
              <tr key={t.name} style={{ borderTop: "1px solid var(--color-border)" }}>
                <td style={{ padding: 4, fontFamily: "var(--font-mono)" }}>
                  {t.name}
      ...
      <div style={box}>
        ...
        <Textarea
          ...
          rows={4}
          style={{ width: "100%", padding: 10, borderRadius: "var(--radius)", border: "1px solid var(--color-border)", background: "var(--color-bg)", color: "var(--color-fg)", fontFamily: "var(--font-mono)", fontSize: 12 }}
        />
