...
const mono: React.CSSProperties = { fontFamily: "var(--font-mono)", fontSize: 11, wordBreak: "break-all" };
...
export function ThemeShowcase() {
  ...
  // ── ブランド色から生成 ──
  const [primary, setPrimary] = React.useState("var(--color-primary)");
      ...
      <div style={{ ...box, marginTop: 16 }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            ...
            <span style={{ background: derived.modes.light.accent, color: "var(--color-bg)", borderRadius: derived.shape.radius, padding: "6px 14px", fontSize: 13 }}>
              アクセント
            </span>
          </div>
        </div>
...
const registry = createThemeRegistry({
  themes: [...builtInThemes, deriveTheme({ id: "acme", name: "ACME", primary: "var(--color-primary)" })],
});
