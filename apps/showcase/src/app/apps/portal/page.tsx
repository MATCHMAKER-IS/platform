...
import { PORTAL_EXTRAS } from "../../../lib/portal-extras.generated";
import { PortalIndex } from "./portal-index";
import { PortalExtrasTabs } from "./portal-extras-tabs";
  ...
  return (
    <>
      <div style={{ maxWidth: 900, margin: "16px auto 0", padding: "0 16px" }}>
        <AppDemoNote usedFor="基盤の目録（何があるかを探す場所）と、構成・ADR・設計の確認" />
      </div>
      <PortalIndex packages={packages} totals={PORTAL_TOTALS} />
      {/* 構成・ヘルス・ADR・Advisor・設計(旧 platform-portal から移設) */}
      <PortalExtrasTabs extras={PORTAL_EXTRAS} />
    </>
  );
}
