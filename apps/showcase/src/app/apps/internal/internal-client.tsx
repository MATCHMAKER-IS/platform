              ...
              <tbody>
                {EXPENSES.map((e) => (
                  <tr key={e.id} style={{ borderTop: "1px solid var(--color-border)" }}>
                    ...
                    <td style={{ ...td, textAlign: "right" }}>{formatYen(e.amount)}</td>
              ...
              <tbody>
                {CONTRACTS.map((c) => (
                  <tr key={c.id} style={{ borderTop: "1px solid var(--color-border)" }}>
                    ...
                    <td style={{ ...td, textAlign: "right" }}>{formatYen((c.amount ?? 0))}</td>
                  </tr>
                ))}
              </tbody>
            </table>
...
const pill: React.CSSProperties = { fontSize: 10, padding: "2px 8px", borderRadius: 999, color: "var(--color-bg)" };
