          ...
          <tbody>
            {[
              ...
              <tr key={String(k)} style={{ borderTop: "1px solid var(--color-border)" }}>
                ...
                <td style={{ ...td, textAlign: "right", fontFamily: "var(--font-mono)" }}>{Number(v).toLocaleString("ja-JP")} 円</td>
              </tr>
            ))}
            <tr style={{ borderTop: "2px solid var(--color-border)" }}>
              <td style={{ ...td, fontWeight: 700 }}>合計</td>
              <td style={{ ...td, textAlign: "right", fontWeight: 700, fontFamily: "var(--font-mono)" }}>{pay.total.toLocaleString("ja-JP")} 円</td>
            </tr>
          </tbody>
        </table>
      </div>
