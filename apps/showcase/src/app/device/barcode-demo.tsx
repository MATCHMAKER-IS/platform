  ...
  return (
    <>
      ...
      <div style={box}>
        ...
        {qr !== "" && (
          <div style={{ display: "flex", gap: 16, alignItems: "flex-start", flexWrap: "wrap", marginTop: 12 }}>
            <div
              style={{ width: 180, height: 180, background: "var(--color-bg)", border: "1px solid var(--color-border)", borderRadius: "var(--radius)", padding: 8 }}
              // safe-source: @platform/barcode が組み立てた SVG。利用者入力はエンコード時に検証済み
      ...
      <div style={box}>
        ...
        {bar !== "" && (
          <div style={{ marginTop: 12, background: "var(--color-bg)", border: "1px solid var(--color-border)", borderRadius: "var(--radius)", padding: 12, overflowX: "auto" }}>
