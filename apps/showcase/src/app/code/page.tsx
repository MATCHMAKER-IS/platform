  ...
  return (
    <main style={{ maxWidth: 860, margin: "2rem auto", padding: "0 1rem" }}>
      ...
      <Textarea value={custom} onChange={(e) => setCustom(e.target.value)} rows={6}
        style={{ width: "100%", fontFamily: "var(--font-mono)", fontSize: 12, padding: 10, borderRadius: "var(--radius)", border: "1px solid var(--color-border)", background: "var(--color-bg)", color: "var(--color-fg)", marginBottom: 12 }} />
