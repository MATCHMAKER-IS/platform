      ...
      <div style={box}>
        ...
        {shown.length === 0 ? (
          ...
          <ul style={{ listStyle: "none", margin: 0, padding: 0, display: "flex", flexDirection: "column", gap: 6 }}>
            {shown.map((e) => (
              <li key={e.id} style={{ fontFamily: "var(--font-mono)", fontSize: 11.5, padding: "8px 10px", borderRadius: 6, background: "var(--color-bg)", border: "1px solid var(--color-border)", wordBreak: "break-all" }}>
