    ...
    <TooltipProvider>
      <>
        ...
        <Section title="カルーセル">
          <div style={{ width: "100%" }}>
            <Carousel loop>
              {["var(--color-primary)", "var(--color-fg)", "var(--color-danger)"].map((c) => (
                <div key={c} style={{ height: 160, background: c, color: "var(--color-bg)", display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "var(--radius)" }}>
                  スライド {c}
                </div>
              ))}
            </Carousel>
