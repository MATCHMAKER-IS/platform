    ...
    <main style={{ maxWidth: 900, margin: "2.5rem auto", padding: "0 1rem" }}>
      ...
      {state.enabled && (
        <div style={box}>
          ...
          <iframe
            title="現在のメンテナンス画面"
            srcDoc={liveHtml}
            style={{ width: "100%", height: 300, border: "1px solid var(--color-danger)", borderRadius: "var(--radius)", background: "var(--color-bg)" }}
          />
      ...
      <div style={box}>
        ...
        <iframe
          ...
          srcDoc={html}
          style={{ width: "100%", height: 380, border: "1px solid var(--color-border)", borderRadius: "var(--radius)", background: "var(--color-bg)" }}
        />
        <p style={{ fontSize: 12, color: "var(--color-muted)", marginTop: 10, lineHeight: 1.8 }}>
