...
const TABS = [
  { id: "a", label: "チャット", Comp: ChatDemo },
  { id: "b", label: "掲示板", Comp: BoardThreadsDemo },
  { id: "c", label: "SMS送信", Comp: SmsDemo },
] as const;
...
export default function Page() {
  ...
  return (
    <main style={{ maxWidth: 1000, margin: "2rem auto", padding: "0 1rem" }}>
      <h1 style={{ fontSize: "1.5rem", fontWeight: 700, marginBottom: 12 }}>チャット・掲示板・SMS</h1>
