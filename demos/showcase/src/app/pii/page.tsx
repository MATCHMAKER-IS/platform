"use client";
/** 個人情報・本人確認 の統合デモ（タブでまとめたもの）。 */
import * as React from "react";
import { Button } from "@platform/ui";
import { PiiDemo } from "./pii-demo";
import { EkycDemo } from "./ekyc-demo";
const TABS = [{ id: "a", label: "個人情報保護(PII)", Comp: PiiDemo }, { id: "b", label: "本人確認(eKYC)", Comp: EkycDemo }] as const;
export default function Page() {
  ...
  return (
    <main style={{ maxWidth: 1000, margin: "2rem auto", padding: "0 1rem" }}>
      <h1 style={{ fontSize: "1.5rem", fontWeight: 700, marginBottom: 12 }}>個人情報・本人確認</h1>
