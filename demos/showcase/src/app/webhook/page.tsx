    ...
    <main style={{ maxWidth: 900, margin: "2rem auto", padding: "0 1rem" }}>
      ...
      <div style={box}>
        ...
        <label style={{ fontSize: 12 }}>
          ...
          <Textarea value={body} onChange={(e) => { setBody(e.target.value); setSignature(""); setRes(null); }} rows={3} style={{ fontFamily: "monospace", fontSize: 12 }} />
        </label>
      ...
      <div style={box}>
        ...
        <label style={{ fontSize: 12 }}>
          ...
          <Input value={signature} onChange={(e) => setSignature(e.target.value)} style={{ fontFamily: "monospace", fontSize: 12 }} />
        </label>
