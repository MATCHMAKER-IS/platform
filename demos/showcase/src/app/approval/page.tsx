...
import { SlackApprovalDemo } from "./slack-approval-demo";
const TABS = [
  { id: "a", label: "承認フロー", Comp: ApprovalDemo },
  { id: "b", label: "状態遷移(FSM)", Comp: FsmDemo },
  { id: "c", label: "Slackで承認", Comp: SlackApprovalDemo },
] as const;
export default function Page() {
  ...
  return (
    <main style={{ maxWidth: 1000, margin: "2rem auto", padding: "0 1rem" }}>
      <h1 style={{ fontSize: "1.5rem", fontWeight: 700, marginBottom: 12 }}>承認フロー・状態遷移</h1>
