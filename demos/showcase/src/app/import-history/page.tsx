"use client";
/** 取り込み・宛先管理 の統合デモ（タブでまとめたもの）。 */
import * as React from "react";
import { Button } from "@platform/ui";
import { ImportDemo } from "./import-demo";
import { RecipientsDemo } from "./recipients-demo";
const TABS = [{ id: "a", label: "CSV取り込み", Comp: ImportDemo }, { id: "b", label: "宛先管理", Comp: RecipientsDemo }] as const;
export default function Page() {
  ...
  return (
    <main style={{ maxWidth: 1000, margin: "2rem auto", padding: "0 1rem" }}>
      <h1 style={{ fontSize: "1.5rem", fontWeight: 700, marginBottom: 12 }}>取り込み・宛先管理</h1>
