 ...
 */
export function themeToCssVars(theme, mode) {
 ...
 */
export function themeToCssBlock(theme, mode, selector = ":root") {
 ...
 */
export function buildThemeStylesheet(themes) {
    const blocks = [];
 ...
 */
export function applySkin(theme, mode, element) {
    if (!element)
        return;
