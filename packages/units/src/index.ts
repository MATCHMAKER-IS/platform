...
/**
 * 面積(基準: 平方メートル)。日本の坪・畳を含む。
 *
 * **`jo`(畳)は 1.62 ㎡。これは不動産公正競争規約の基準**で、
 * 広告に「1 畳」と書くときの下限として定められている値。
 * **実際の畳の大きさとは違う**——京間・中京間は 1.6562 ㎡、
 * 江戸間は約 1.5488 ㎡、団地間は約 1.4450 ㎡と**地域で異なる**。
 *
 * 物件の広告や面積の目安には 1.62 で正しいが、
 * **実測が要る用途(内装・畳の発注)には使えない**。
 * その場合は地域の規格を確かめて個別に計算すること(2026-08 に明記)。
 */
